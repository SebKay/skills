...
2. Apply the layout and token contract from [references/layout-token-contract.md](references/layout-token-contract.md).
3. Implement in three passes: structure, styling, review.
4. Run a manual coverage pass using [references/mockup-coverage-checklist.md](references/mockup-coverage-checklist.md).
5. Report exact matches, intentional deviations, and unresolved ambiguities.
